...
" Name:       aranda
" Author:     Kyoz
" Repository: https://github.com/kyoz/aranda/
...
let g:airline#themes#aranda#palette = {}

function! airline#themes#aranda#refresh()
    " Define colors
    let s:colors = aranda#get_colors()
    ...
    let g:airline#themes#aranda#palette.normal =
        \ airline#themes#generate_color_map(s:N1, s:N2, s:N3)
    let g:airline#themes#aranda#palette.normal_modified = {
    ...
    let g:airline#themes#aranda#palette.insert = 
        \ airline#themes#generate_color_map(s:I1, s:I2, s:I3)
    let g:airline#themes#aranda#palette.insert_modified = 
        \ g:airline#themes#aranda#palette.normal_modified
    ...
    let g:airline#themes#aranda#palette.replace =
        \ airline#themes#generate_color_map(s:R1, s:R2, s:R3)
    let g:airline#themes#aranda#palette.replace_modified =
        \ g:airline#themes#aranda#palette.normal_modified
    ...
    let g:airline#themes#aranda#palette.visual = airline#themes#generate_color_map(s:V1, s:V2, s:V3)
    let g:airline#themes#aranda#palette.visual_modified = g:airline#themes#aranda#palette.normal_modified
    ...
    let s:IA3 = s:N2
    let g:airline#themes#aranda#palette.inactive = airline#themes#generate_color_map(s:IA1, s:IA2, s:IA3)
    let g:airline#themes#aranda#palette.inactive_modified = {
        \ 'airline_c': [ s:group[0], '', s:group[2], '', '']
        \ }
    ...
    let g:airline#themes#aranda#palette.accents = {
...
call airline#themes#aranda#refresh()
